...
public:
    ...
    /// <summary>
    /// Sets the model for speech synthesis.
    /// </summary>
    /// <param name="name">The voice name of the embedded synthesis model.</param>
    /// <param name="key">The model decryption key.</param>
    void SetSpeechSynthesisModel(const SPXSTRING& name, const SPXSTRING& key="")
    {
    ...
    /// <summary>
    /// Gets the model name for speech synthesis.
    /// </summary>
    /// <returns>The speech synthesis model name, i.e. the voice name.</returns>
    SPXSTRING GetSpeechSynthesisModelName() const
    {
