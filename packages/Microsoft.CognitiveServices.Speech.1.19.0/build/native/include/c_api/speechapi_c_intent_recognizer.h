...
SPXAPI intent_recognizer_add_simple_language_intent(SPXRECOHANDLE hreco, const char* modelId, const char* intentId, const char* const* phrases , size_t phrasesSize);
